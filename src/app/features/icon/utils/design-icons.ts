...
export const designIconKeys = {
  ...
  LEFT_OPENABLE_ARROW_AWAY_OUTSIDE: 'leftOpenableArrowAwayOutside',
  LEFT_OPENABLE_ARROW_TOWARDS_OUTSIDE: 'leftOpenableArrowTowardsOutside',

  //the below are outside view, for inside view use mirror images of these 2 (total 4 svgs were present in dashboard)
  RIGHT_OPENABLE_ARROW_AWAY_OUTSIDE: 'rightOpenableArrowAwayOutside',
  RIGHT_OPENABLE_ARROW_TOWARDS_OUTSIDE: 'rightOpenableArrowTowardsOutside',
...
export const DESIGN_ICONS: Partial<Record<IconPrefixType, Partial<Record<IconKey, string>>>> = {
  [IconPrefix.OPENABLE_DESIGNS]: {
    ...
    [designIconKeys.LEFT_OPENABLE_ARROW_AWAY_OUTSIDE]: `<svg
    ...
    [designIconKeys.LEFT_OPENABLE_ARROW_TOWARDS_OUTSIDE]: `<svg
                        *ngIf="arrowTowardsHandle && viewHandleFromOutside"
                        xmlns="http://www.w3.org/2000/svg"
                        width="40"
                        height="50"
    ...
    [designIconKeys.RIGHT_OPENABLE_ARROW_AWAY_OUTSIDE]: `<svg
                        *ngIf="!arrowTowardsHandle && viewHandleFromOutside"
                        xmlns="http://www.w3.org/2000/svg"
                        width="40"
                        height="50"
    ...
    [designIconKeys.RIGHT_OPENABLE_ARROW_TOWARDS_OUTSIDE]: `<svg
                        *ngIf="arrowTowardsHandle && viewHandleFromOutside"
                        xmlns="http://www.w3.org/2000/svg"
                        width="40"
                        height="50"
    ...
    viewBox="0 0 40 50" *ngIf="!arrowTowardsHandle">
    ...
    [designIconKeys.TOP_HUNG_ARROW_TOWARDS]: `<svg  *ngIf="arrowTowardsHandle" xmlns="http://www.w3.org/2000/svg" width="40" height="50" viewBox="0 0 46 60">
