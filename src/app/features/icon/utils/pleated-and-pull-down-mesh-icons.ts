...
export const pleatedAndPullDownMeshIconKeys = {
  LEFT_PLEATED_MESH: 'leftPleatedMesh', //For rightPleatedMesh use the mirror image of this (leftPleatedMesh)
...
export const PLEATED_AND_PULL_DOWN_MESH_ICONS: Record<string, Record<string, string>> = {
