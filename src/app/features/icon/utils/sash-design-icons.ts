...
export const sashDesignIconKeys = {
  ...
  // all below images here used as mirror images // these are the outside view for inside need to be flipped(by conditional) all 10 means 20( 10*2) images
  TWIN_SASH_LEFT_OPENABLE_ARROW_AWAY_OUTSIDE: 'twinSashLeftOpenableArrowAwayOutside',
  TWIN_SASH_LEFT_OPENABLE_ARROW_TOWARDS_OUTSIDE: 'twinSashLeftOpenableArrowTowardsOutside',

  TWIN_SASH_RIGHT_OPENABLE_ARROW_AWAY_OUTSIDE: 'twinSashRightOpenableArrowAwayOutside',
  TWIN_SASH_RIGHT_OPENABLE_ARROW_TOWARDS_OUTSIDE: 'twinSashRightOpenableArrowTowardsOutside',

  TWIN_SASH_FRENCH_OPENABLE_ARROW_AWAY_OUTSIDE: 'twinSashFrenchOpenableArrowAwayOutside',
  TWIN_SASH_FRENCH_OPENABLE_ARROW_TOWARDS_OUTSIDE: 'twinSashFrenchOpenableArrowTowardsOutside',

  TWIN_SASH_TOP_HUNG_ARROW_AWAY_OUTSIDE: 'twinSashTopHungArrowAwayOutside',
  TWIN_SASH_TOP_HUNG_ARROW_TOWARDS_OUTSIDE: 'twinSashTopHungArrowTowardsOutside',

  TWIN_SASH_BOTTOM_HUNG_ARROW_AWAY_OUTSIDE: 'twinSashBottomHungArrowAwayOutside',
  TWIN_SASH_BOTTOM_HUNG_ARROW_TOWARDS_OUTSIDE: 'twinSashBottomHungArrowTowardsOutside',

  //only mesh-sash
  LEFT_MESH_SASH: 'leftMeshSash', // the rightMeshSash can be used as leftMeshSash by flipping the image
...
export const SASH_DESIGN_ICONS: Partial<Record<IconPrefixType, Partial<Record<IconKey, string>>>> = {
  [IconPrefix.TWIN_SASH]: {
    ...
    [sashDesignIconKeys.TWIN_SASH_RIGHT_OPENABLE_ARROW_AWAY_OUTSIDE]: `<svg
                      *ngIf="!arrowTowardsHandle && viewHandleFromOutside"
                      ...
                      viewBox="0 0 40 50"
                    >
                      <g id="Group_37023" data-name="Group 37023" transform="translate(-3 -445)">
                        <g id="Group_14373" data-name="Group 14373" transform="translate(-101 197)">
                          <g
                            id="Rectangle_4467"
                            data-name="Rectangle 4467"
                            transform="translate(104 248)"
                          ...
                          <g id="Path_20487" data-name="Path 20487" transform="translate(108 251.846)">
                            <path id="Path_60097" data-name="Path 60097" d="M31.5,41.808H.5V.5h31Z" fill="none" />
                            <path
                              id="Path_60098"
                          ...
                          <path
                            ...
                            d="M145.8,253.515,116.583,234.45l29.874-19.3"
                            transform="translate(-7.457 39.003)"
                            fill="none"
                            stroke="#96a0b5"
                            stroke-width="1"
                          ...
                          <rect
                            ...
                            width="4.04"
                            height="7.692"
                            transform="translate(139 269.154)"
                            fill="#96a0b5"
                          />
                          <rect
                            id="Rectangle_4488"
                            ...
                            width="2"
                            height="8.654"
                            transform="translate(137 273)"
                            fill="#96a0b5"
                          />
                        </g>
                        <g id="Group_37022" data-name="Group 37022" transform="translate(3.5 466.5)">
                          <line
                            id="Line_1649"
                            data-name="Line 1649"
                            x1="39"
    ...
    [sashDesignIconKeys.TWIN_SASH_RIGHT_OPENABLE_ARROW_TOWARDS_OUTSIDE]: `<svg
                      *ngIf="arrowTowardsHandle && viewHandleFromOutside"
                      xmlns="http://www.w3.org/2000/svg"
                      width="40"
                      height="50"
                      ...
                      <g id="Group_37023" data-name="Group 37023" transform="translate(-3 -445)">
                        <g id="Group_14373" data-name="Group 14373" transform="translate(-101 197)">
                          ...
                          <path
                            ...
                            data-name="Path 20366"
                            d="M145.8,253.515,116.583,234.45l29.874-19.3"
                            transform="translate(255.583 507.668) rotate(180)"
                            fill="none"
                            stroke="#96a0b5"
                            stroke-width="1"
                            stroke-dasharray="3 2"
    ...
    [sashDesignIconKeys.TWIN_SASH_FRENCH_OPENABLE_ARROW_AWAY_OUTSIDE]: `<svg
                    *ngIf="!arrowTowardsHandle && viewHandleFromOutside"
                    xmlns="http://www.w3.org/2000/svg"
                    width="40"
                    height="50"
    ...
    [sashDesignIconKeys.TWIN_SASH_FRENCH_OPENABLE_ARROW_TOWARDS_OUTSIDE]: `<svg
                    *ngIf="arrowTowardsHandle && viewHandleFromOutside"
                    xmlns="http://www.w3.org/2000/svg"
                    width="40"
                    height="50"
    ...
    [sashDesignIconKeys.TWIN_SASH_LEFT_OPENABLE_ARROW_AWAY_OUTSIDE]: `<svg
                  *ngIf="!arrowTowardsHandle && viewHandleFromOutside"
                  xmlns="http://www.w3.org/2000/svg"
                  width="40"
                  height="50"
    ...
    [sashDesignIconKeys.TWIN_SASH_LEFT_OPENABLE_ARROW_TOWARDS_OUTSIDE]: `<svg
                  *ngIf="arrowTowardsHandle && viewHandleFromOutside"
                  xmlns="http://www.w3.org/2000/svg"
                  width="40"
                  height="50"
    ...
    [sashDesignIconKeys.TWIN_SASH_BOTTOM_HUNG_ARROW_AWAY_OUTSIDE]: `<svg
                *ngIf="!arrowTowardsHandle && viewHandleFromOutside"
                xmlns="http://www.w3.org/2000/svg"
                width="40"
                height="50"
    ...
    [sashDesignIconKeys.TWIN_SASH_BOTTOM_HUNG_ARROW_TOWARDS_OUTSIDE]: `<svg
                *ngIf="arrowTowardsHandle && viewHandleFromOutside"
                xmlns="http://www.w3.org/2000/svg"
                width="40"
                height="50"
