...
export const sheetBoundedDesignIconKeys = {
  SHEET_BOUNDED_PIVOT_LEFT_OPENABLE: 'sheetBoundedPivotLeftOpenable', //sheetBoundedPivotRightOpenable can  be done by its mirror ( and left's mirror)
  SHEET_BOUNDED_PIVOT_TOP_OPENABLE: 'sheetBoundedPivotTopOpenable', //sheetBoundedPivotBottomOpenable can be done by its mirror ( left's mirror)

  SHEET_BOUNDED_LEFT_OPENABLE: 'sheetBoundedLeftOpenable', // sheetBoundedRightOpenable can be done by its mirror ( and left's mirror)
