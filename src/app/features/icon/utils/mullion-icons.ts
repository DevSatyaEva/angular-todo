...
export const mullionIconKeys = {
  VERTICAL_MULLION: 'verticalMullion', //Kept this, for horizontalMullion, rotate this to right by 90 degrees
  VERTICAL_MULTIPLE_MULLLION: 'verticalMultipleMullion', //kept this, for horizontalMultipleMullion, rotate this to right by 90 degrees
  I_JOINT: 'iJoint',
  L_JOINT: 'lJoint',
  T_JOINT: 'tJoint',
...
export const MULLION_ICONS: Partial<Record<IconPrefixType, Partial<Record<IconKey, string>>>> = {
  [IconPrefix.DIVIDER]: {
    ...
    [mullionIconKeys.VERTICAL_MULTIPLE_MULLLION]: `<svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 36.905 36.905">
