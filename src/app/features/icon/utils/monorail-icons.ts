...
export const monorailIconKeys = {
  ONE_FIX_ONE_SLIDING_NOT_HANDLE_OUTSIDE: 'oneFixOneSlidingnNotHandleOutside', //kept this, for oneFixOneSlidingHandleOutside, do the mirror image of this (2 svgs were present)

  ONE_FIX_TWO_SLIDING_ONE_FIX_NOT_HANDLE_OUTSIDE: 'oneFixTwoSlidingOneFixNotHandleOutside', //kept this, for oneFixTwoSlidingOneFixHandleOutside, do the mirror image of this (2 svgs were present)

  ONE_SLIDING_TWO_X_FIX_ONE_SLIDING: 'oneSlidingTwoxFixOneSliding',

  ONE_SLIDING_ONE_FIX_NOT_HANDLE_OUTSIDE: 'oneSlidingOneFixNotHandleOutside', //kept this, for oneSlidingOneFixHandleOutside, do the mirror image of this (2 svgs were present)

  VERTICAL_MONORAIL: 'verticalMonorail',

  ONE_FIX_ONE_L_AND_S_NOT_HANDLE_OUTSIDE: 'oneFixOneLAndSNotHandleOutside', //kept this, for oneFixOneLAndSHandleOutside use mirror image of this, for oneLAndSOneFixNotHandleOutside use the flip image of oneFixOneLAndSNotHandleOutside and for oneLAndSOneFixHandleOutside,use this same image (oneFixOneLAndSNotHandleOutside)
  ONE_FIX_TWO_L_AND_S_ONE_fix_NOT_HANDLE_OUTSIDE: 'oneFixTwoLAndSOneFixNotHandleOutside', //kept this, for oneFixTwoLAndSOneFixHandleOutside, use the mirror image
...
export const MONORAIL_ICONS: Partial<Record<IconPrefixType, Partial<Record<IconKey, string>>>> = {
  ...
  [IconPrefix.MONORAIL_LIFT_AND_SLIDE]: {
    [monorailIconKeys.ONE_FIX_ONE_L_AND_S_NOT_HANDLE_OUTSIDE]: `<svg *ngIf="!viewHandleFromOutside" width="72" height="52" viewBox="0 0 72 52" fill="none"
    xmlns="http://www.w3.org/2000/svg">
