...
export const customIconKeys = {
  ...
  PENTAGON_WITH_STAIRS_ON_LEFT: 'pentagonWithStairsOnLeft',
  PENTAGON: 'pentagon',
  ...
  RIGHT_TRAPEXIUM_WITH_GOTHIC_ARC_IN_RIGHT: 'rightTrapexiumWithGothicArcInRight',
  OCTAGON: 'octagon',
  ...
  RIGHT_TRAPEZIUM_ON_RIGHT: 'rightTrapeziumOnRight',
