export const SOCIAL_ICONS: Record<string, Record<string, string>> = {
  fw: {
    // Prefix 'fw' (FontWeight)
    bell: `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
               <path d="M12 2C9.24 2 7 4.24 7 7V13L5 15V17H19V15L17 13V7C17 4.24 14.76 2 12 2ZM12 22C13.1 22 14 21.1 14 20H10C10 21.1 10.9 22 12 22Z" fill="currentColor"/>
             </svg>`,
