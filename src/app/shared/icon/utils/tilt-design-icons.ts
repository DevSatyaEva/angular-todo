...
export const tiltDesignIconKeys = {
  T_AND_S_LEFT_HANDLE: 'tAndSLeftHandle',
  T_AND_T_LEFT_HANDLE_ARROW_HINGE_OUTSIDE: 'tAndTLeftHandleArrowHingeOutside',
  T_AND_T_LEFT_HANDLE_ARROW_HANDLE_OUTSIDE: 'tAndTLeftHandleArrowHandleOutside',
  T_AND_T_FRENCH_WINDOW_ARROW_HANDLE_OUTSIDE: 'tAndTFrenchWindowArrowHandleOutside',
  T_AND_T_FRENCH_WINDOW_ARROW_HANDLE_INSIDE: 'tAndTFrenchWindowArrowHandleInside',
  T_AND_T_WITH_OPENABLE_FRENCH: 'tAndTWithLeftOpenableFrench',
} as const;
...
export const TILT_DESIGN_ICONS: Partial<Record<IconPrefixType, Partial<Record<IconKey, string>>>> = {
  [IconPrefix.TILT]: {
    ...
    [tiltDesignIconKeys.T_AND_T_FRENCH_WINDOW_ARROW_HANDLE_OUTSIDE]: `<svg
    ...
    [tiltDesignIconKeys.T_AND_T_FRENCH_WINDOW_ARROW_HANDLE_INSIDE]: `<svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="80"
                      height="50"
                      viewBox="0 0 76 60"
    ...
    [tiltDesignIconKeys.T_AND_T_LEFT_HANDLE_ARROW_HANDLE_OUTSIDE]: `<svg
                xmlns="http://www.w3.org/2000/svg"
                width="40"
                height="50"
                viewBox="0 0 40 50"
    ...
    [tiltDesignIconKeys.T_AND_T_LEFT_HANDLE_ARROW_HINGE_OUTSIDE]: `<svg
                xmlns="http://www.w3.org/2000/svg"
                width="40"
                height="50"
                viewBox="0 0 40 50"
