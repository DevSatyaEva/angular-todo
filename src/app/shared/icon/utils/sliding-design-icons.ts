...
export const slidingDesignIconKeys = {
  ...
  TWO_TRACK_FOUR_PANEL_MEETING: 'twoTrackFourPanelMeeting',
  FOUR_TRACK_FOUR_PANEL: 'fourTrackFourPanel',
  THREE_TRACK_FIVE_PANEL_MEETING_BOTH_LEFT: 'threeTrackFivePanelMeetingBothLeft',
  THREE_TRACK_FIVE_PANEL_MEETING_BOTH_RIGHT: 'threeTrackFivePanelMeetingBothRight',
  FIVE_TRACK_FIVE_PANEL: 'fiveTrackFivePanel',
  TWO_TRACK_SIX_PANEL_MEETING: 'twoTrackSixPanelMeeting',
  THREE_TRACK_SIX_PANEL_MEETING: 'threeTrackSixPanelMeeting',
  ...
  FOUR_TRACK_EIGHT_PANEL_MEETING: 'fourTrackEightPanelMeeting',
  FIVE_TRACK_TEN_PANEL_MEETING: 'fiveTrackTenPanelMeeting',
  SIX_TRACK_TWELVE_PANEL_MEETING: 'sixTrackTwelvePanelMeeting',
  ...
  TELESCOPIC_THREE_TRACK_THREE_PANEL_LEFT_OPENING: 'telescopicThreeTrackThreePanelLeftOpening',
  TELESCOPIC_THREE_TRACK_THREE_PANEL: 'telescopicThreeTrackThreePanel',

  TELESCOPIC_FOUR_TRACK_FOUR_PANEL_LEFT_OPENING: 'telescopicFourTrackFourPanelLeftOpening',
  TELESCOPIC_FOUR_TRACK_FOUR_PANEL: 'telescopicFourTrackFourPanel',

  TELESCOPIC_FIVE_TRACK_FIVE_PANEL_LEFT_OPENING: 'telescopicFiveTrackFivePanelLeftOpening',
  TELESCOPIC_FIVE_TRACK_FIVE_PANEL: 'telescopicFiveTrackFivePanel',

  TELESCOPIC_THREE_TRACK_SIX_PANEL: 'telescopicThreeTrackSixPanel',
  TELESCOPIC_SIX_TRACK_SIX_PANEL_LEFT_OPENING: 'telescopicSixTrackSixPanelLeftOpening',
