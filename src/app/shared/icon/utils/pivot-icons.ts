...
export const pivotIconKeys = {
  PIVOT_LEFT_OPENABLE_ARROW_HINGE_OUTSIDE: 'pivotLeftOpenableArrowHingeOutside',
  PIVOT_LEFT_OPENABLE_ARROW_HANDLE_OUTSIDE: 'pivotLeftOpenableArrowHandleOutside',

  PIVOT_TOP_OPENABLE_ARROW_HINGE_OUTSIDE: 'pivotTopOpenableArrowHingeOutside',
  PIVOT_TOP_OPENABLE_ARROW_HANDLE_OUTSIDE: 'pivotTopOpenableArrowHandleOutside',
} as const;
...
export const PIVOT_ICONS: Partial<Record<IconPrefixType, Partial<Record<IconKey, string>>>> = {
  [IconPrefix.PIVOT]: {
    [pivotIconKeys.PIVOT_LEFT_OPENABLE_ARROW_HINGE_OUTSIDE]: `<svg
    ...
    [pivotIconKeys.PIVOT_LEFT_OPENABLE_ARROW_HANDLE_OUTSIDE]: `<svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="40"
                        height="50"
                        viewBox="0 0 40 50"
    ...
    [pivotIconKeys.PIVOT_TOP_OPENABLE_ARROW_HINGE_OUTSIDE]: `<svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="40"
                        height="50"
                        viewBox="0 0 40 50"
    ...
    [pivotIconKeys.PIVOT_TOP_OPENABLE_ARROW_HANDLE_OUTSIDE]: `<svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="40"
                        height="50"
                        viewBox="0 0 40 50"
