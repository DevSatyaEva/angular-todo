...
export const partitionIconKeys = {
  ...
  PARTITION_LEFT_OPENABLE_ARROW_HINGE_OUTSIDE: 'partitionLeftOpenableArrowHingeOutside',
  PARTITION_LEFT_OPENABLE_ARROW_HANDLE_OUTSIDE: 'partitionLeftOpenableArrowHandleOutside',

  PARTITION_FRENCH_OPENABLE_ARROW_HANDLE_OUTSIDE: 'partitionFrenchOpenableArrowHandleOutside',
  PARTITION_FRENCH_OPENABLE_ARROW_HINGE_OUTSIDE: 'partitionFrenchOpenableArrowHingeOutside',
} as const;
...
export const PARTITION_ICONS: Partial<Record<IconPrefixType, Partial<Record<IconKey, string>>>> = {
  [IconPrefix.PARTITION]: {
    ...
    [partitionIconKeys.PARTITION_LEFT_OPENABLE_ARROW_HINGE_OUTSIDE]: `<svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="40"
                        height="50"
                        viewBox="0 0 46 60"
    ...
    [partitionIconKeys.PARTITION_LEFT_OPENABLE_ARROW_HANDLE_OUTSIDE]: `<svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="40"
                        height="50"
                        viewBox="0 0 46 60"
    ...
    [partitionIconKeys.PARTITION_FRENCH_OPENABLE_ARROW_HANDLE_OUTSIDE]: `<svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="40"
                        height="50"
                        viewBox="0 0 53 60"
    ...
    [partitionIconKeys.PARTITION_FRENCH_OPENABLE_ARROW_HINGE_OUTSIDE]: `<svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="40"
                        height="50"
                        viewBox="0 0 53 60"
